...
const getDriverLineup = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        $("fieldset").each(function () {
            const firstName = $(this).find("div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > span:nth-child(1)").text().trim();
            const secondName = $(this).find("div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > span:nth-child(2)").text().trim();
            const team = $(this).find(" p:nth-child(2)").text();
            const rank = $(this).find("div:nth-child(3) > picture:nth-child(2) > img:nth-child(2)").attr("data-src");
            const nationalityImage = $(this)
                .find("div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > picture:nth-child(1) > img:nth-child(2)")
                .attr("data-src");
            const driverImage = $(this).find(" div:nth-child(3) > picture:nth-child(1) > img:nth-child(2)").attr("data-src");
